    ...
    <div class="box">
        <div class="box-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="int">Kondisi Barang <?php echo form_error('kondisi') ?></label>
                ...
                <div class="form-group">
                    <label for="id_lokasi">Lokasi <?php echo form_error('id_lokasi') ?></label>
                ...
                <div class="form-group">
                    <label for="tanggal_pengadaan">Tanggal Pengadaan <?php echo form_error('tanggal_pengadaan') ?></label>
