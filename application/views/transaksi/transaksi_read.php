    ...
    <div class="box">
        <div class="box-body">
            <table class="table">
        	    ...
        	    <tr><td>Tanggal Datang</td><td><?php echo $tanggal_datang; ?></td></tr>
        	    <tr><td>Tanggal Distribusi</td><td><?php echo $tanggal_distribusi; ?></td></tr>
        	    <tr><td>Status</td><td><?php echo $status; ?></td></tr>
        	    <tr><td><a href="<?= base_url("assets/bap/".$bap) ?>" class="btn btn-default"><i class="fa fa-file"></i> Download Surat BAP</a></td><td><a href="<?php echo site_url('transaksi') ?>" class="btn btn-default">Cancel</a></td></tr>
        	</table>
